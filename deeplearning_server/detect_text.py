...
class DetectText:
    def __init__(self):
        ...
        self.trained_model = "./deeplearning_server/weights/craft_mlt_25k.pth"
    ...
    def detect_net(self, image):
        ...
        boxes, polys = craft_utils.getDetBoxes(score_text, score_link, self.text_threshold, self.link_threshold, self.low_text)
